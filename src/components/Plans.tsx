  ...
  const mainPlans = [
    {
      ...
      color: 'blue',
      features: [
        'Chatbot WhatsApp com menus e botões interativos',
        'Agendamento automatizado 24h',
        'Paciente escolhe dia e horário pelo próprio chat',
        'Lembretes automáticos antes da consulta',
        'Painel para visualizar e aprovar agendamentos',
        'Histórico completo de conversas',
        'Respostas rápidas personalizadas (FAQs do consultório)',
        '1 médico · 1 agenda · 1 atendente no painel',
      ],
    ...
    },
    {
      ...
      features: [
        'Tudo do Essencial',
        'Integração Google Calendar — agenda sincronizada, sem duplicidade',
        'Integração Gestão DS — disponibilidade em tempo real',
        'Confirmações e cancelamentos atualizam o calendário automaticamente',
        'Múltiplos atendentes no painel (médico + recepcionista)',
        'Notificações automáticas de confirmação por WhatsApp',
        'Relatórios mensais de atendimento e performance',
    ...
    },
    {
      ...
      features: [
        ...
        '2 ou mais médicos com agendas independentes',
        'Bot roteia automaticamente por especialidade',
        'Gestão de fila de espera por médico/especialidade',
        'Automação de no-show — bot oferece reagendamento automático',
        'Relatórios separados por médico e especialidade',
        'Atendentes ilimitados no painel',
        'Onboarding dedicado + treinamento da equipe',
        'Whitelabel — sem marca DoctorChatBot (opcional)',
      ],
